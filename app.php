...
<html lang="ja">
    <head>
        ...
        <meta property="og:url" content="https://chat.taka.ml/" />
        ...
        <meta property="og:image" content="https://chat.taka.ml/assets/img/icon.png" />
    ...
    <body>
	    ...
	    <main>
            <div class="app">
                <?php if(!empty($server)){ ?>
                    <h1 class="title"><a class="invalidLink" href="./app"><?= $server["name"] ?></a></h1>
                    ...
                    <?php } ?>
                <?php }else{ ?>
                    <h1 class="title"><a class="invalidLink" href="./">サーバー一覧</a></h1>
