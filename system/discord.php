...
function get_user(){
    ...
    $_SESSION["id"] = $res["id"];
    $_SESSION["avatar"] = "https://cdn.discord.com/avatar/".$res["id"]."/".$res["avatar"].is_animated($res["avatar"])."?size=1024"
    if($results["accent_color"]) $_SESSION["accent_color"] = $res["accent_color"];
